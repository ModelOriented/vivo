...
```{r}
wyn <- LocalVariableImportanceViaOscillations(cp = cp_rf, df = df[, 2:11])
ggplot(wyn$result, aes(x = variable_name, y = measure)) + geom_bar(stat="identity") + labs(x = "`_x_`", y = "measure")
```
...
```{r}
wyn1 <- LocalVariableImportanceViaOscillations(cp = cp_rf, df = df[,2:11], kernel = "rectangular", bw_density = "SJ")
ggplot(wyn1$result, aes(x = variable_name, y = measure)) + geom_bar(stat="identity") + labs(x = "`_x_`", y = "measure")
```
...
```{r}
wyn <- LocalVariableImportanceViaOscillations(cp_rf, apartments[,2:5])
ggplot(wyn$result, aes(x = variable_name, y = measure)) + geom_bar(stat="identity") + labs(x = "`_x_`", y = "measure")
```
...
```{r}
wyn1 <- LocalVariableImportanceViaOscillations(cp_rf, apartments[,2:5], kernel = "rectangular", bw_density = "SJ")
ggplot(wyn1$result, aes(x = variable_name, y = measure)) + geom_bar(stat="identity") + labs(x = "`_x_`", y = "measure")
```
